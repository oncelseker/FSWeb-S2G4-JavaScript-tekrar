...
tekraredensayilar = [];
for (let sayi in tekrarEdenSayilarObje) {
  if (tekrarEdenSayilarObje[sayi] > 1) {
    tekraredensayilar.push(`${sayi} sayisi ${tekrarEdenSayilarObje[sayi]} kere tekrar edilmiştir`);
  }
} 
